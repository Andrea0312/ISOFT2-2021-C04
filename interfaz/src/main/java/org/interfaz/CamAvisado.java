...
public class CamAvisado extends JDialog {
	...
	public CamAvisado() {
		...
		{
			JLabel lblLosCamarerosHan = new JLabel("Los camareros han sido avisados satisfactoriamente");
			contentPanel.add(lblLosCamarerosHan);
		}
		{
